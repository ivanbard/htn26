...
This uses the repository's existing Python/Lua test runtime to check the
manifest, Lua syntax, and display-state smoke flow. A physical badge, NFC tag,
display rendering, and firmware NFC behavior remain hardware-only validation
requirements.
