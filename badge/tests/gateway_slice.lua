...
assert(world.count("HTN26|HOST|CONTROL|OC2|000001|G|S") == 1)
assert(world.count("HTN26|RX|00:00:00:00:01:02|-40|OC2|000001|E|P1:READY") == 1)
...
assert(world.count("HTN26|RX|00:00:00:00:01:02|-40|OC2|000002|E|P1:PU:B") == 1)
...
assert(world.count("HTN26|HOST|CONTROL|OC2|000002|G|E") == 1)
...
assert(gateway.transport.send("OC2|000001|G|S"))
world.settle()
assert(player.shows("GAME ENDED"))
gateway.env.on_button(3, 1) -- begin a fresh host-owned round
world.settle()
assert(player.shows("GAME STARTED"))
assert(gateway.transport.send("OC2|000002|G|E"))
world.settle()
assert(player.shows("GAME STARTED"))
